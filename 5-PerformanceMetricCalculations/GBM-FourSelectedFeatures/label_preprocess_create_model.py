...
def train_rf_classifier(input_file, output_file):
    ...
    clf = GradientBoostingClassifier(n_estimators=600, min_samples_split=15, min_samples_leaf=1, max_depth=25, random_state=42)
...
if __name__ == '__main__':
    ...
    train_rf_classifier('preprocessed_data.csv', 'gbc_model.pkl')
