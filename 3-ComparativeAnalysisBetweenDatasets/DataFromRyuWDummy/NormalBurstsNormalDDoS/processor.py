...
while True:
    ...
    log_line = f"[{current_time}] ryuCPU: {ryu_cpu_percentage}%, ryuMEM: {ryu_memory_usage}MB, hping3CPU: {hping3_cpu_percentage}%, hping3MEM: {hping3_memory_usage}MB, TotalCPU: {total_cpu_percentage}%, TotalMEM: {total_memory_percentage}%\n"
